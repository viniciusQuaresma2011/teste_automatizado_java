...
public class CarrinhoPage {
	...
	private By taxasValor = By.cssSelector("div.cart-summary-totals div.cart-summary-line:nth-child(3) span.value");
	...
	public String obter_taxasValor() {
		return driver.findElement(taxasValor).getText();
	}
