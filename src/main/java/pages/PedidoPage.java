...
public class PedidoPage {
	...
	private By totalProdutos = By.cssSelector("#order-items > div.order-confirmation-table > div > div.col-sm-6.col-xs-12.qty > div > div.col-xs-4.text-sm-center.text-xs-right.bold");
	private By totalTaxIncl = By.cssSelector("#order-items > div.order-confirmation-table > table > tbody > tr.total-value.font-weight-bold > td:nth-child(2)");
